...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-6 ">
                    <div class="footer_content">
                        ...
                        <form class="subscrib" method="post">
                            <input type="text" class="cust_textbox" placeholder="Enter email" name="txtEmail">
                            <span class="err">Plese Enter Email Address</span>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.subscrib').submit(function() {
        var cust_textbox = $('.cust_textbox').val();
        var cust_textbox_pt = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;


        if (cust_textbox_pt.test(cust_textbox) == "") {
            $('.cust_textbox').next('.err').css('display', 'block')
            return false;
        }
    ...
    $('.cust_textbox').keypress(function() {
        $('.err').hide()
    })
        })
