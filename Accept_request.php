		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="hidden" name="user_name" id="user_name" class="form-control ret"  value="<?php echo $_SESSION["UserID"];  ?>" />
				</div>
				<div class="form-group">
					<textarea name="user_review" id="user_review" class="form-control ret_txt" placeholder="Type Review Here"></textarea>
					<input type="hidden" name="hddfeedmansi" id="hddfeedmansi">
						<input type="hidden" name="hdd" id="hdd">
				</div>
