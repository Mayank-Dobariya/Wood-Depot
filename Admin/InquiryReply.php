    ...
    <div class="content-wrapper bg-white">
        <div class="content-header mt-5">
            ...
            <div class="container-fluid">
                <?php
                $strIn = "select * from tbl_inquiry where inquiry_id=" . $IID;
                $rsIn = mysqli_query($conn, $strIn) or die(mysqli_error($conn));
                $resIn = mysqli_fetch_array($rsIn);
                ?>
                <?php
                if ($resIn["product_id"] != NULL) {
                    $str = "select *,c.category,ct.category_type_name,i.description as d from tbl_inquiry i, tbl_product p,tblcategory c,tbl_category_type ct where c.id=p.category_id and ct.id=p.category_type_id  and p.product_id=i.product_id and i.inquiry_id=" . $IID;
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h2 class="card-title"><?php echo $res["product_name"] . " Product"; ?></h2>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="quickForm" class="pkg_form" method="post">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <b><?php echo $res["category"]; ?></b>
                                                </label>
                                            </div>
                                            <div class="form-group">
                                                <label>Category Type :</label>
                                                <b><?php echo $res["category_type_name"]; ?></b>
                                                </label>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                ?>
                                                    ...
                                                    <textarea id="" cols="90" rows="10" name="txtReply"></textarea>
