                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="label_form">
                        <form class="edit_form">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <input type="hidden" class="form-control" name="ORDER_ID" id="ORDER_ID" placeholder="Package ID" readonly value=<?php echo  $_SESSION["PackageID"]; ?>>
                                </div>
                                <?php
                                if (isset($_SESSION["InteriorDesignerID"])) {
                                ?>
                                    <div class="col-sm-12 col-md-6">
                                        <input id="CUST_ID" name="CUST_ID" type="hidden" class="form-control" placeholder="Interior ID" readonly value="<?php echo $_SESSION["InteriorDesignerID"]; ?>">
                                ...
                                <div class="col-6">
                                    <label class="text-light" style="font-size: 22px;">Price</label>
